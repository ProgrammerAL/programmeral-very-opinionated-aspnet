...
builder.Services.AddSingleton<IAzureCredentialsManager, AzureCredentialsManager>();
...
builder.Services.AddOptions<AzureCredentialsConfig>().Bind(builder.Configuration.GetSection(nameof(AzureCredentialsConfig)));
