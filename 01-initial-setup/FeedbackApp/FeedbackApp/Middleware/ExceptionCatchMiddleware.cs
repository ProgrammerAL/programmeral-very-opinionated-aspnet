...
public class ExceptionCatchMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                outputMessage += outputException.Message + Environment.NewLine + Environment.NewLine;
                outputException = outputException.InnerException;
            }

            var errorObj = new ErrorResponse(ErrorMessage: outputMessage, TraceId: Tracer.CurrentSpan.Context.TraceId.ToString());
